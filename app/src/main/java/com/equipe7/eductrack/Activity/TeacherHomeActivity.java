...
public class TeacherHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDashboard = findViewById(R.id.btnDashboard); // Dashboard enseignant
    ...
    private void setupCombinedCarousel() {
        List<com.equipe7.eductrack.models.CarouselItem> combinedItems = new ArrayList<>();

        combinedItems.add(new com.equipe7.eductrack.models.CarouselItem(R.drawable.bebe_eleve, "Welcome", "Learning Together"));
        combinedItems.add(new com.equipe7.eductrack.models.CarouselItem(R.drawable.mission_image, "Our Mission", "Educate & Inspire"));
        combinedItems.add(new com.equipe7.eductrack.models.CarouselItem(R.drawable.eleve, "Students", "Motivation & Success"));
        combinedItems.add(new com.equipe7.eductrack.models.CarouselItem(R.drawable.eleve_png, "Education", "For Everyone"));
        combinedItems.add(new com.equipe7.eductrack.models.CarouselItem(R.drawable.groupe_eleve_deux, "Teamwork", "Together is Better"));
        combinedItems.add(new com.equipe7.eductrack.models.CarouselItem(R.drawable.c_eleve, "Trust", "Support & Respect"));
        combinedItems.add(new com.equipe7.eductrack.models.CarouselItem(R.drawable.charte, "Charter", "Values & Discipline"));
        combinedItems.add(new com.equipe7.eductrack.models.CarouselItem(R.drawable.c_ejeux, "Educational Games", "Learning Through Play"));
