...
public class AdminForgotPassword extends AppCompatActivity {
    ...
    private void sendOtp() {
        ...
        // 🔍 Rechercher l’admin par champ "email"
        db.collection("admins")
                ...
                .addOnSuccessListener(querySnapshot -> {
                    if (!querySnapshot.isEmpty()) {
                        ...
                        adminDoc.getReference().update("otp", otp, "used", false, "timestamp", System.currentTimeMillis());
    ...
    private void sendEmailJS(String email, String otp) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> {
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(AdminForgotPassword.this, "Failed to send OTP: " + e.getMessage(), Toast.LENGTH_LONG).show();
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                runOnUiThread(() -> {
                    ...
                    if (response.isSuccessful()) {
                        Toast.makeText(AdminForgotPassword.this, "OTP sent to your email", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(AdminForgotPassword.this, "Failed to send OTP", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
